...
This skill adds Slack support to ClaudeClaw, then walks through interactive setup.
...
```bash
git remote add slack https://github.com/sbusso/claudeclaw-slack.git
```
...
6. Restart: `launchctl kickstart -k gui/$(id -u)/com.claudeclaw`
